...
public class InferTypeVariablesTest {
		...
		throws TypeInferenceException
	{
		...
		TypeInference.inferTypeVariables(compT, u, typeAssigns);
		...
		throws TypeInferenceException
	{
		...
		final Map<TypeVariable<?>, TypeMapping> typeAssigns = new HashMap<>();
		TypeInference.inferTypeVariables(listT.getType(), listWildcard.getType(),
			typeAssigns);
			...
			throws TypeInferenceException
	{
		...
		TypeInference.inferTypeVariables(type, inferFrom, typeAssigns);
		...
		throws TypeInferenceException
	{
		...
		Map<TypeVariable<?>, TypeMapping> typeAssigns = new HashMap<>();
		TypeInference.inferTypeVariables(iterableO, object, typeAssigns);
		...
		throws TypeInferenceException
	{
		...
		Map<TypeVariable<?>, TypeMapping> typeAssigns = new HashMap<>();
		TypeInference.inferTypeVariablesWithTypeMappings(tArr, badInferFrom,
			typeAssigns);
		...
		throws TypeInferenceException
	{
		...
		final Map<TypeVariable<?>, TypeMapping> typeAssigns = new HashMap<>();
		TypeInference.inferTypeVariablesWithTypeMappings(types, inferFroms,
			typeAssigns);
		...
		throws TypeInferenceException
	{
		...
		final Map<TypeVariable<?>, TypeMapping> typeAssigns = new HashMap<>();
		TypeInference.inferTypeVariablesWithTypeMappings(tArgs, destArgs,
			typeAssigns);
	...
	public <T> void testWildcardTypeInference() throws TypeInferenceException {
		...
		TypeInference.inferTypeVariablesWithTypeMappings(types2, inferFroms2,
			typeAssigns2);
