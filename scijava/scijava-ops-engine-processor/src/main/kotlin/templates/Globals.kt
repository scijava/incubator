...
abstract class Globals(val sourceDir: File, val packageName: String, val className: String) {
    ...
    fun genericsNamesList(arity: Int) =
    ...
    fun acceptArgs(arity: Int): String = computeArgs(arity)


    fun build() {
        val dir = File(sourceDir, packageName)
        dir.mkdirs()
