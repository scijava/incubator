...
zImg = op.ternary("transform.hyperSliceView").input(fittedImg, param.ltAxis, 0).apply()
AImg = op.ternary("transform.hyperSliceView").input(fittedImg, param.ltAxis, 1).apply()
tauImg = op.ternary("transform.hyperSliceView").input(fittedImg, param.ltAxis, 2).apply()
...
After running this script, the output shown below can be seen by first running the script, and then brightness and contrast (Ctrl + Shift + C, select "Auto") 
